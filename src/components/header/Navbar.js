...
export default function Navbar() {
  return (
    <header className='w-full bg-000 pos-relative z-5'>
        <nav className='flex w-full container-4xl-w mx-auto pos-relative px-4-md grow-1'>
            <div className='w-full py-3 flex pos-relative z-2 justify-between'>
                ...
                <div className='flex'>
                    <Link>
                        <div className='relative flex p-1 mr-8'>
                            ...
                            <span className='absolute right-0 text-center text-xs bg-blue-700 p-1 rounded-[50%] text-white flex justify-center items-center' style={{width : "20px" , height : "20px"}}>5</span>
                        </div>
                    </Link>
                </div>
            </div>
