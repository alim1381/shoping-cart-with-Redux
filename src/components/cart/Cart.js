    ...
    return (
        <main className='mt-[80px] flex'>
            <div className='w-2/3 p-7'>
                {
                    data.cart.map(item => (
                        <div className='border flex justify-around items-center p-2 m-3 rounded-md'>
                        ...
                        data.checkout ?
                            ...
                            data.itemCounter > 0 ? 
                                <div className='w-full flex'>
                                    <button onClick={() => dispatch(clear())} className='p-2 w-1/2 bg-blue-700 text-white text-sm text-center m-1 rounded-md'>Clear</button>
                                    <button onClick={() => dispatch(checkout())} className='p-2 w-1/2 bg-blue-700 text-white text-sm text-center m-1 rounded-md'>Check Out</button>
                                </div>        
                                :
